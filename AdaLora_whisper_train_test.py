...
from peft import PeftModel,  get_peft_model, PeftModel, PeftConfig, AdaLoraModel, AdaLoraConfig
...
def train_model(args):
    ...
    config = AdaLoraConfig(r=32, lora_alpha=64, target_modules=["q_proj", "v_proj"], lora_dropout=0.05, bias="none")
...
# openai/whisper-large-v2  openai/whisper-large  openai/whisper-medium  openai/whisper-small  openai/whisper-base  openai/whisper-tiny
    ...
    parser.add_argument('--output_dir', default="/data2/Users/yan/01Results/whisper/fast-whisper-finetuning/adalora_result/large-v3/", help='output filepath')
    ...
    parser.add_argument('--peft_model_id', default="Yan20231017/whisper-large-v3-adalora-hu-epoch5", help='peft_model_id')
